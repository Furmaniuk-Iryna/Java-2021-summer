...
<button class="btn btn-light right_button" type="button"><a class="button_locale" href="directionReport?city=${city}&page=${currentPage}&locale=uk">UKR</a></button>
<button class="btn btn-light right_button" type="button"><a class="button_locale" href="directionReport?city=${city}&page=${currentPage}&locale=en">ENG</a></button>
<br>
